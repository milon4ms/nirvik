...
৪. পরামর্শ: এ অংশে রোগীর জন্য অনুমোদিত খাবার,বর্জনীয় খাবার, বিশ্রাম, ব্যায়াম ও জীবনযাপনের সংক্ষিপ্ত পরামর্শ উল্লেখ করবেে
...
// ---------- ফলাফল দেখানো, কপি, এবং টুলস ফাংশন (পূর্বের ন্যায়) ----------
...
function getResultText() {
    const resultDiv = document.getElementById('result');
    if (!resultDiv) { alert('⚠️ ফলাফল বক্স পাওয়া যায়নি!'); return null; }
...
// ---------- বাটন ডায়নামিক্যালি তৈরি (আপডেটেড) ----------
function createButtons() {
    ...
    const buttons = [
        ...
        { id: 'copyPromptBtn', class: 'btn btn-copy', icon: '📋', text: 'কপি করুন', type: 'button', action: copyResult },
    ...
    buttons.forEach(btnData => {
        ...
        btn.id = btnData.id; btn.className = btnData.class;
