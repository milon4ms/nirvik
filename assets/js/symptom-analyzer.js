...
function generateSymptomPrompt() {
    ...
    let promptText = `আমি একজন অভিজ্ঞ হোমিওপ্যাথিক চিকিৎসক। আমার রোগীর লক্ষণসমূহ বিশ্লেষণ করে তোমাকে দিচ্ছি, তুমি লক্ষণ সমুহ  হোমিওপ্যাথিক রেপার্টরিসমুহে যাচাই করে হোমিওপ্যাথিক নিয়ম নীতি অনুযায়ী সঠিক ঔষধ নির্বাচন করবে। এমন কোনো ঔষধ নির্বাচন করবেন না যা পরস্পরের ক্রিয়া নাশক (Antidote), শত্রুভাবাপন্ন (Inimical) বা রোগ বৃদ্ধিকারক।`;
    ...
    promptText += `নির্দেশনা: তুমি আউটপুট দিবে ২টি অংশে। প্রথম অংশে থাকবে প্রেসক্রিপশন ; দ্বিতীয় অংশে থাকবে চিকিৎসকের জ্ঞাতার্থে নামক অংশ।
...
৫.রোগ লক্ষণ সমুহ: ৬. রোগের সম্ভব্য নাম: 
চিকিৎসকের জ্ঞাতার্থে ফরম্যাট: ৭. বিকল্প ঔষধ সমুহের তালিকা  ৮. ঔষধের সংক্ষিপ্ত লক্ষণ: ৯. এলোপ্যাথিক ঔষধ: ১০. ইউনানি ঔষধ: ১১. রেপার্টরি রুব্রিক তালিকা: ১২. সতর্কতা:  ১৩. প্যাথলজি পরীক্ষা: 
...
৭. বিকল্প ঔষধ সমুহের তালিকা: লক্ষণের সাথে মিল আছে এমন ৬-৭টি ঔষধের তালিকা। (এই তালিকার কোনো ঔষধ যদি পরস্পরের ক্রিয়া নাশক বা শত্রু হয়, তাহলে স্পষ্ট সতর্কতা দিও)
৮. ঔষধের সংক্ষিপ্ত লক্ষণ:১. ২. ৩. ৭. নং পয়েন্টে যে সকল ঔষধ এর নাম এসেছে তাদেরকে কেন সিলেক্ট করা হয়েছে তার সংক্ষেপে বিবরণ অর্থাৎ রোগলক্ষণের সাথে সম্পর্ক 
